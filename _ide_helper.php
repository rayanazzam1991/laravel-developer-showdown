...
namespace Illuminate\Support\Facades {
     ...
     */        class Auth {
         ...
         *
         * @return \App\Features\SyncUserAttributes\Infrastructure\Repository\Eloquent\Model\User|null 
         * @static 
         ...
         *
         * @param mixed $id
         * @return \App\Features\SyncUserAttributes\Infrastructure\Repository\Eloquent\Model\User|false 
         * @static 
         ...
         *
         * @return \App\Features\SyncUserAttributes\Infrastructure\Repository\Eloquent\Model\User 
         * @static 
